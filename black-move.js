function moveBlack1(){
    if (document.getElementById("black-1").style.top === "15.5vw"){
        document.getElementById("black-1").style.top = "21.5vw";
    }  
}

function moveBlack2(){
    if (document.getElementById("black-2").style.top === "15.5vw"){
        document.getElementById("black-2").style.top = "21.5vw";
    }  
}
function moveBlack3(){
    if (document.getElementById("black-3").style.top === "15.5vw"){
        document.getElementById("black-3").style.top = "21.5vw";
    }  
}
function moveBlack4(){
    if (document.getElementById("black-4").style.top === "15.5vw"){
        document.getElementById("black-4").style.top = "21.5vw";
    }  
}
function moveBlack5(){
    if (document.getElementById("black-5").style.top === "15.5vw"){
        document.getElementById("black-5").style.top = "21.5vw";
    }  
}
function moveBlack6(){
    if (document.getElementById("black-6").style.top === "15.5vw"){
        document.getElementById("black-6").style.top = "21.5vw";
    }  
}
function moveBlack7(){
    if (document.getElementById("black-7").style.top === "15.5vw"){
        document.getElementById("black-7").style.top = "21.5vw";
    }  
}
function moveBlack8(){
